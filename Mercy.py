...
\033[1;92m\n 
 ...
 ______   __       ________   __  __   ______   ______       
/_____/\ /_/\     /_______/\ /_/\/_/\ /_____/\ /_____/\      
\::::_\/_\:\ \    \::: _  \ \\ \ \ \ \\:::_:\ \\:::_ \ \     
 \:\/___/\\:\ \    \::(_)  \ \\:\_\ \ \  /_\:\ \\:(_) ) )_   
  \_::._\:\\:\ \____\:: __  \ \\::::_\/  \::_:\ \\: __ `\ \  
    /____\:\\:\/___/\\:.\ \  \ \ \::\ \  /___\:\ '\ \ `\ \ \ 
    \_____\/ \_____\/ \__\/\__\/  \__\/  \______/  \_\/ \_\/
                                   
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: slayer
\033[1;92mFb \033[1;93m: ジ气覀气亠 亠
...
def log_sel():
	...
	main()
        ...
        os.system('xdg-open https://www.facebook.com/sslama1223')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UCSUvGTkOTZsrNtqKYZRLXIA')
        main()
    else:
        print ''
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##THANKX SLAYER BRO
    print ''
    crack_select()
